...
public enum CraftingItem {
    ...
    OPAL ("Opal", "Opal", CraftingType.JEM_CUTTING, 1, 15, new ItemReq("Chisel"), new ItemReq("Uncut opal", 1)),
    JADE ("Jade", "Jade", CraftingType.JEM_CUTTING, 13, 20, new ItemReq("Chisel"), new ItemReq("Uncut jade", 1)),
    RED_TOPAZ ("Red topaz", "Red topaz", CraftingType.JEM_CUTTING, 16, 25, new ItemReq("Chisel"), new ItemReq("Uncut red topaz", 1)),
    SAPPHIRE ("Sapphire", "Sapphire", CraftingType.JEM_CUTTING, 20, 50, new ItemReq("Chisel"), new ItemReq("Uncut sapphire", 1)),
    EMERALD ("Emerald", "Emerald", CraftingType.JEM_CUTTING, 27, 67.5f, new ItemReq("Chisel"), new ItemReq("Uncut emerald", 1)),
    RUBY ("Ruby", "Ruby", CraftingType.JEM_CUTTING, 34, 85, new ItemReq("Chisel"), new ItemReq("Uncut ruby", 1)),
    DIAMOND ("Diamond", "Diamond", CraftingType.JEM_CUTTING, 43, 107.5f, new ItemReq("Chisel"), new ItemReq("Uncut diamond", 1)),
    DRAGONSTONE ("Dragonstone", "Dragonstone", CraftingType.JEM_CUTTING, 55, 137.5f, new ItemReq("Chisel"), new ItemReq("Uncut dragonstone", 1)),
    ONYX ("Onyx", "Onyx", CraftingType.JEM_CUTTING, 67, 167.5f, new ItemReq("Chisel"), new ItemReq("Uncut onyx", 1)),
